...
blp = Blueprint('projects', __name__, description='Operations with projects')
...
class CreatePost(MethodView):
    ...
    def post(self, post_data):
        try:
            ...
            post_model = ProjectModel(author_id=user.id, **post_data) # you need create another object!!
